...
tdm.2t <- removeSparseTerms(tdm.2, 0.99999)
...
tdm.3t <- removeSparseTerms(tdm.3, 0.99999)
...
Consider writing probability distribution tables to flat files and using that for the app. Do all analysis in a separate file, etc.
